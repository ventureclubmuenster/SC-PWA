            ...
            <div key={i} className="noise-panel rounded-2xl p-4 space-y-3 border border-[#E8E8ED] shadow-sm">
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                  <div className="h-9 w-9 animate-pulse rounded-full bg-[#E8E8ED]" />
                  <div className="space-y-1.5">
                    <div className="h-4 w-28 animate-pulse rounded-lg bg-[#E8E8ED]" />
                    <div className="h-3 w-36 animate-pulse rounded bg-[#E8E8ED]" />
                  </div>
                </div>
                <div className="h-4 w-16 animate-pulse rounded-full bg-[#E8E8ED]" />
              </div>
              <div className="flex gap-2">
                <div className="h-9 flex-1 animate-pulse rounded-xl bg-[#E8E8ED]" />
                <div className="h-9 flex-1 animate-pulse rounded-xl bg-[#E8E8ED]" />
              </div>
            </div>
          ))}
